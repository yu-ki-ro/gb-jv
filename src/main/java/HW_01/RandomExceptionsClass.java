...
public class RandomExceptionsClass {
    public static void main(String[] args) throws IOException {
        ...
        int a = 10, b = 2; // Изменено значение b на ненулевое
        callMethod6("");
    ...
    private static void callMethod3(ArrayList<String> stringArraysList) {
        if (stringArraysList.isEmpty()) {
            return; // Добавлено условие выхода из рекурсии
        }
        callMethod6("");
        callMethod3(stringArraysList);
    }
    ...
    public static int callMethod2(int a, int b) throws IOException {
        ...
        int num = callMethod4("124"); // Исправлена строка на "124"
        return a / b;
    }
    ...
    private static void callMethod5(String s) {
        ...
        for (int i = 0; i < strings.length; i++) { // Исправлена индексация массива
            strings[i] = s;
        }
    }
}